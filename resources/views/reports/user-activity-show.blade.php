<x-app-layout>
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-blue-500 rounded-2xl shadow-lg p-8 text-white mb-6">
        <h1 class="text-3xl font-bold">
            {{ $user->name }} Screening Activity
        </h1>
        <p class="mt-2 text-indigo-100">
            List of journals screened by this user.
        </p>
    </div>
            ...
            <tbody class="divide-y">
                @forelse($journals as $journal)
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 font-bold text-indigo-600">{{ $average }}/10</td>
                        <td class="px-6 py-4">
                ...
                @empty
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                            No journals screened by this user.
                        </td>
                    </tr>
                @endforelse
            </tbody>
